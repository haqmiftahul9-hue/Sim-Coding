import { Code, Link, MessageSquare, FileDown, CheckCircle } from 'lucide-react'
      ...
      {isSubmitted ? (
        <div className="flex flex-col sm:flex-row gap-4 items-start">
          ...
          <div className="flex-1 space-y-3">
            ...
            {submission.github && (
              <div>
                <label className="font-label-sm text-label-sm text-on-surface-variant block mb-1">Tautan GitHub</label>
                <a
                  href={`https://${submission.github}`}
                  target="_blank"
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="font-label-md text-label-md text-on-surface-variant">{student.nama} belum mengumpulkan tugas</p>
          <p className="font-label-sm text-label-sm text-outline mt-1">Deadline: 20 Januari 2024</p>
        </div>
      )}
    </div>
  )
